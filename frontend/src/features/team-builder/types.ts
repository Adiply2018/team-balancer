...
export const RANKS = [
  ...
  { value: "SILVER I", label: "Silver I", color: "text-gray-700" },
  { value: "SILVER II", label: "Silver II", color: "text-gray-700" },
  { value: "SILVER III", label: "Silver III", color: "text-gray-700" },
  { value: "SILVER IV", label: "Silver IV", color: "text-gray-700" },
  ...
  { value: "IRON I", label: "Iron I", color: "text-gray-900" },
  { value: "IRON II", label: "Iron II", color: "text-gray-900" },
  { value: "IRON III", label: "Iron III", color: "text-gray-900" },
  { value: "IRON IV", label: "Iron IV", color: "text-gray-900" },
].reverse();
